...
import { extractChoiceOptions, stripHiddenBlocks } from '../engine/content-blocks.ts';
...
const extractedW2pOptions = extractChoiceOptions(`
<w2p mode="routes">
<w2p_analysis>这里是选项规划，不应显示。</w2p_analysis>
1) 前往综合服务大厅
2. 留在原地观察
C：向响木天音询问
</w2p>
...
assertDeepEqual(
  extractedW2pOptions,
  [
    { label: 'A', text: '前往综合服务大厅' },
    { label: 'B', text: '留在原地观察' },
    { label: 'C', text: '向响木天音询问' },
  ],
  'w2p blocks use the shared choice parser',
);
assertEqual(
  stripHiddenBlocks('正文内容\n<w2p>A. 不应进入正文</w2p>'),
  '正文内容',
  'w2p block is hidden from narrative text',
);
...
console.log('[desktop-panel-runtime] 14 cases passed');
