...
const FULLBODY_PORTRAIT_META: Array<Omit<FullbodyPortraitProfile, 'portraitUrl'>> = [
  { fileName: '响木天音校服.png', names: ['响木天音校服', '响木天音', '天音'], affiliation: '学生会' },
  ...
  { fileName: '克莉丝汀_1.png', names: ['克莉丝汀_1', '克莉丝汀'], affiliation: '学生会' },
  ...
  { fileName: '夏洛特.png', names: ['夏洛特'], affiliation: '瓦莱里乌斯皇家学院 (世界排名第三) → 天海学园交换生(转学后)' },
  ...
  { fileName: '安洁莉卡.png', names: ['安洁莉卡'], affiliation: '聖·塞拉芬娜修道院 (教会附属) → 天海学园交换生(若转学)' },
  ...
  { fileName: '布伦希尔德.png', names: ['布伦希尔德', '布伦', '希尔德'], affiliation: '教师' },
  ...
  { fileName: '望月静.png', names: ['望月静', '望月', '静'], affiliation: '一年级B班 / 图书委员会 / (暗地里) 望月极道会' },
  ...
  { fileName: '艾米莉亚.png', names: ['艾米莉亚'] },
  { fileName: '艾米莉威廉姆斯.png', names: ['艾米莉威廉姆斯', '艾米丽威廉姆斯', '艾米丽', '威廉姆斯'], affiliation: 'BF社 实验组长' },
