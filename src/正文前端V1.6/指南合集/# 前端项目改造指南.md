# 前端项目改造指南 - 类似 mhjg 和 horr 项目

## 📋 概述

本文档说明如何将一个现有的前端项目改造成类似 `mhjg` 和 `horr` 的项目。这两个项目都采用了统一的架构模式，包括开局流程、变量系统、请求处理和事件监听等核心功能。
...
- **adventure 项目**：`src/adventure/` - React 项目完整实现示例（推荐）
  - `src/adventure/components/GameScreen.css` - 完整的样式系统实现
  - `src/adventure/components/GameScreen.tsx` - React 组件实现
  - `src/adventure/utils/gameInitializer.ts` - 游戏初始化实现
  - `src/adventure/utils/variableReader.ts` - 变量读取实现
  - `src/adventure/utils/requestHandler.ts` - 统一请求处理实现
  - `src/adventure/utils/chronicleUpdater.ts` - 编年史更新实现
  - `src/adventure/utils/messageParser.ts` - 消息解析实现

- **horr 项目**：`src/horr/` - React 项目简化实现示例
  - `src/horr/utils/gameInitializer.ts` - 游戏初始化实现
  - `src/horr/utils/variableReader.ts` - 变量读取实现
  - `src/horr/utils/unifiedRequestHandler.ts` - 统一请求处理实现

- **mhjg 项目**：`src/mhjg/` - 非 React 项目实现示例
  - `src/mhjg/utils/gameInitializer.ts` - 游戏初始化实现
  - `src/mhjg/utils/variableReader.ts` - 变量读取实现
  - `src/mhjg/utils/unifiedRequestHandler.ts` - 统一请求处理实现

### 样式参考

- **adventure 项目样式**：
  - `src/adventure/components/GameScreen.css` - 完整的 CSS 变量系统、主题系统、响应式设计
  - `src/adventure/components/views/*.css` - 各个视图组件的样式实现

- **zhutiangame 项目样式**：
  - `src/zhutiangame/styles/responsive.scss` - 响应式样式实现
  - `src/zhutiangame/styles/variables.scss` - SCSS 变量系统

- **项目设计流程总结**：
  - `项目设计流程总结与提示词.md` - 样式规范总结、窗口大小规范、全屏模式支持
...
完成以上步骤后，你的前端项目就具备了与 `mhjg` 和 `horr` 项目相同的核心功能。如果遇到问题，请参考参考实现或查看调试日志。
...
- **adventure 项目**：`src/adventure/` - React 项目完整实现示例
- **horr 项目**：`src/horr/` - React 项目简化实现示例
- **mhjg 项目**：`src/mhjg/` - 非 React 项目实现示例
...
**完成提示**：完成以上所有步骤后，你的项目就具备了完整的游戏初始化、变量管理、请求处理、编年史更新等核心功能。如果遇到问题，请参考实际项目代码（特别是 adventure 项目）或查看详细的调试日志。