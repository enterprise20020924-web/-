...
const CONTEXTUAL_ACTION_LABEL_PATTERN =
  /^(?:她|他|TA|Ta|ta|这个女人|那个女人|这女人|那女人|这个男人|那个男人|这男人|那男人|这个人|那个人|对方|女人|男人|少女|少年|女生|男生|女学生|男学生).*(?:心里|内心|心中|脑海|默念|心想|想道|想着|低声|轻声|柔声|冷声|厉声|开口|回应|说|问|喊|道|念叨|嘟囔|低语|喃喃|抬头|抬起头|低头|转头|转过头|回头|看向|垂眸|没有抬头)$/;
const CONTEXTUAL_ACTION_PARAGRAPH_PATTERN =
  /^(?:她|他|TA|Ta|ta|这个女人|那个女人|这女人|那女人|这个男人|那个男人|这男人|那男人|这个人|那个人|对方|女人|男人|少女|少年|女生|男生|女学生|男学生)[^。！？!?；;\n]{0,48}(?:心里|内心|心中|脑海|默念|心想|想道|想着|低声|轻声|柔声|冷声|厉声|开口|回应|说|问|喊|道|念叨|嘟囔|低语|喃喃|抬头|抬起头|低头|转头|转过头|回头|看向|垂眸|没有抬头)/;
const CONTEXTUAL_ATTRIBUTION_PATTERN =
  /(?:^|[。！？!?；;，,]\s*)(?:她(?:的声音)?|他(?:的声音)?|TA|Ta|ta|这个女人|那个女人|这女人|那女人|这个男人|那个男人|这男人|那男人|这个人|那个人|对方|女人|男人|少女|少年|女生|男生|女学生|男学生)[^。！？!?；;\n]{0,48}(?:低声说|低声道|回答道|解释道|提醒道|压低声音|补了一句|轻笑说|微笑说|冷声说|厉声说|轻声说|答道|回答|解释|提醒|嘟囔|念叨|笑道|骂道|吼道|叫道|低语|喃喃|开口|回应|说|问|喊|道|抬头|抬起头|低头|转头|转过头|回头|看向|垂眸|没有抬头)[：:，,。！？!?]*$/;
...
const LEADING_ACTION_AFTER_SPEAKER_PATTERN =
  /^(?:自始至终|始终|一直|仍然|仍旧|依旧|还是|只是|正|正在|终于|缓缓|慢慢|并没有|没有|未曾|从|向|朝|对|把|被|在|低头|抬头|抬起头|转头|转过头|转身|回头|看向|垂眸|走|跑|站|坐|靠|停|凑|退|伸|收|拿|放|推|拉|扶|抱|夹|拍|点|摇|眨|睁|眯|皱|抿|咬|捂|笑|轻笑|微笑|苦笑|愣|怔|叹|开口|回应|说|问|喊|道)/;
const LEADING_ACTION_SUBJECT_PATTERN =
  /^([\u4e00-\u9fa5A-Za-z]{2,10})(?=(?:自始至终|始终|一直|仍然|仍旧|依旧|还是|只是|正|正在|终于|缓缓|慢慢|并没有|没有|未曾|从|向|朝|对|把|被|在|低头|抬头|抬起头|转头|转过头|转身|回头|看向|垂眸|走|跑|站|坐|靠|停|凑|退|伸|收|拿|放|推|拉|扶|抱|夹|拍|点|摇|眨|睁|眯|皱|抿|咬|捂|笑|轻笑|微笑|苦笑|愣|怔|叹|开口|回应|说|问|喊|道))/;
...
function findLastExplicitSpeaker(segments: DialogueSegment[]) {
...
function findMentionedKnownSpeaker(paragraph: string, source: DialogueSource) {
  const matches = source.knownCharacters
    .filter(isPlausibleSpeakerLabel)
    .filter(speaker => !isSourceUserSpeaker(speaker, source))
...
export function splitDialogueSource(source: DialogueSource): DialogueSplitResult {
  ...
  paragraphs.forEach((paragraph, paragraphIndex) => {
    ...
    const explicitSpeaker = findLastExplicitSpeaker(paragraphSegments);
    const mentionedSpeaker = findMentionedKnownSpeaker(paragraph, source);

    segments.push(...paragraphSegments);

    const contextSpeaker =
      explicitSpeaker !== null && !isSourceUserSpeaker(explicitSpeaker, source) ? explicitSpeaker : mentionedSpeaker;
